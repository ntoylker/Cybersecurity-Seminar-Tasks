...
# 4. GDPR Explanation (Question 4)
"""
[GDPR COMMENT]
H ψευδωνυμοποίηση βοηθά στην προστασία των προσωπικών δεδομένων διότι διαχωρίζει 
τα δεδομένα ταυτοποίησης (identifiers) από τα δεδομένα ανάλυσης.
Ακόμα και αν το αρχείο με τα ψευδωνυμοποιημένα δεδομένα διαρρεύσει ή υποκλαπεί, 
δεν μπορεί να συνδεθεί με φυσικά πρόσωπα χωρίς τον Πίνακα Αντιστοίχισης (Mapping Table), 
ο οποίος φυλάσσεται ξεχωριστά και κρυπτογραφημένος.
Αυτό μειώνει τον κίνδυνο για τα υποκείμενα των δεδομένων (Άρθρο 32 GDPR).
"""
